...
namespace AAMT
{
    public static class AssetsBundleBuilder
    {
        ...
        public static void BuildAssetsBundles()
        {
            ...
            var path = SettingManager.assetSetting.getEditorBuildPath.ToLower();
        ...
        {
            var txtPath = Path.Combine(SettingManager.assetSetting.getEditorBuildPath, AAMTDefine.AAMT_ASSET_VERSION);
            var dirPath = SettingManager.assetSetting.getEditorBuildPath;
        ...
        {
            var files = Directory.GetFiles(SettingManager.assetSetting.getEditorBuildPath, "*.manifest",
                SearchOption.AllDirectories);

            var mapPath = Path.Combine(SettingManager.assetSetting.getEditorBuildPath,
            ...
            var buildPath = SettingManager.assetSetting.getEditorBuildPath + "/";
            var i = 1;
        ...
        {
            var path = SettingManager.assetSetting.getEditorBuildPath;

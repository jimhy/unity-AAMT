...
Shader "Unlit/raodongrongjie_alp"
{
	Properties
	{
		...
		_zhezhao_col("zhezhao_col", Color) = (0.3370862,0.6460618,0.9528302,1)
		...
		_rongjie("rongjie", Range( -1 , 1)) = 0.3319695
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 tex2DNode2 = tex2D( _zhezhao, uv_zhezhao );
				...
				finalColor = ( ( ( ( tex2DNode2.r * _zhezhao_int * _zhezhao_col ) + ( ( tex2D( _noise02, panner50 ).r * tex2DNode2.r * tex2D( _noise01, panner37 ).r ) * _noise_shuchu_col * _noise_shuchu_int ) ) + ( ( ifLocalVar10 - ifLocalVar12 ) * _bian_col ) + ( fresnelNode24 * _fre_col ) ) * ifLocalVar10 * tex2DNode2.r );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18800
7;134;1920;885;3190.203;883.5984;1.357643;True;False
Node;AmplifyShaderEditor.Vector2Node;49;-3061.809,-786.4097;Inherit;False;Property;_noise02UV_tilling;noise02UV_tilling;6;0;Create;True;0;0;0;False;0;False;0.5,0.5;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;43;-2987.943,-324.8163;Inherit;False;Property;_noise01UV_tilling;noise01UV_tilling;3;0;Create;True;0;0;0;False;0;False;0.5,0.5;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;38;-2818.439,-164.4073;Half;False;Property;_noise01UV_speed;noise01UV_speed;4;0;Create;True;0;0;0;False;0;False;0.25,-0.1;0.5,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;16;-1845.149,379.6985;Half;False;Property;_liangbian_kuan;liangbian_kuan;14;0;Create;True;0;0;0;False;0;False;0.023;0.023;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1915.049,119.4984;Half;False;Property;_rongjie;rongjie;15;0;Create;True;0;0;0;False;0;False;0.3319695;-1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;9;-1816.516,-68.5742;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;33;-1840.861,497.1337;Inherit;False;Property;_lizi_Kzhen_kaiguan;lizi_Kzhen_kaiguan;17;1;[Enum];Create;True;2;;;2;vertex col;1;rongjie;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-2442.987,-608.1863;Inherit;True;Property;_zhezhao;zhezhao;8;0;Create;True;0;0;0;False;0;False;-1;7071e07fa23648d419aea21e368c17ec;f1f61188a50a38c45b99ffd59c7a5300;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;17;-1538.149,444.6985;Inherit;True;Property;_rongjie_noise;rongjie_noise;13;0;Create;True;0;0;0;False;0;False;-1;c731e6eda2c42074ba007036dffcf653;c731e6eda2c42074ba007036dffcf653;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;51;-2478.368,-833.8646;Inherit;True;Property;_noise02;noise02;5;0;Create;True;0;0;0;False;0;False;-1;9a5e528b267ca6e4f8142b0e51a681b9;9a5e528b267ca6e4f8142b0e51a681b9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;39;-2404.502,-372.2712;Inherit;True;Property;_noise01;noise01;2;0;Create;True;0;0;0;False;0;False;-1;9a5e528b267ca6e4f8142b0e51a681b9;c42170903af8e11448bc6c56d447d026;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1759.774,-615.7757;Inherit;False;Property;_zhezhao_int;zhezhao_int;10;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-2069.888,-176.6645;Half;False;Property;_noise_shuchu_int;noise_shuchu_int;12;0;Create;True;0;0;0;False;0;False;1.5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;64;-1806.094,-866.3069;Inherit;False;Property;_zhezhao_col;zhezhao_col;9;0;Create;True;0;0;0;False;0;False;0.3370862,0.6460618,0.9528302,1;0.3370862,0.6460618,0.9528302,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;42;-2098.616,-366.7213;Half;False;Property;_noise_shuchu_col;noise_shuchu_col;11;0;Create;True;0;0;0;False;0;False;0.4056604,0.4056604,0.4056604,1;0.145098,0.3921569,0.7490196,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;21;-718.064,602.1138;Half;False;Property;_bian_col;bian_col;16;1;[HDR];Create;True;0;0;0;False;0;False;1,0.9229986,0.4292453,1;0.3773585,0.3773585,0.3773585,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;28;-810.0991,-681.7206;Half;False;Property;_fre_col;fre_col;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0.25,0.4776938,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;-1559.498,-703.6276;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;-1773.593,-465.5408;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;62;-1136.218,-506.4227;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;22;-362.7318,-347.6521;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;222.0483,-13.48809;Half;False;True;-1;2;ASEMaterialInspector;100;1;Unlit/raodongrongjie_alp;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;True;0;False;-1;True;2;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;2;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=7266B2F2FBB196E54C67F8250AFA28F61CA1CBE2
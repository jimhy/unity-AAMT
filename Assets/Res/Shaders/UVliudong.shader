	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 appendResult6 = (half4(( _tex01_col * tex2DNode2.r * _tex01_int * i.ase_color ).rgb , ( _tex01_col.a * tex2DNode2.a * i.ase_color.a * ( tex2D( _MainTex, uv_MainTex ).r * _zhezhao_int ) )));
...
/*ASEBEGIN
Version=18800
7;247;1920;772;1537.237;125.641;1.165427;True;False
...
Node;AmplifyShaderEditor.SamplerNode;12;-540.639,426.8316;Inherit;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=1F25E8CE202C009DA298EE31118721CA37AC5F10
...
Shader "Unlit/liudong_zhezhaoUV"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 appendResult6 = (half4(( ( ( tex2D( _NOISE01, panner11 ).r * tex2D( _NOISE02, panner12 ).r * _NOISE1_2COL * _NOISE1_2INT ) + ( tex2D( _NOISE03, panner13 ).r * _NOISE3COL * _NOISE03INT ) ) * i.ase_color ).rgb , ( ( tex2DNode34.r + tex2DNode34.g ) * tex2D( _zhezhao, uv_zhezhao ).r * tex2D( _liudong_zhezhao02, panner14 ).r * _zhezhao_int * i.ase_color.a )));
...
/*ASEBEGIN
Version=18800
0;0;1920;1019;2289.359;-231.203;1.3;True;False
...
Node;AmplifyShaderEditor.Vector2Node;30;-2049.946,730.4375;Inherit;False;Property;_noise03uv_speed;noise03uv_speed;7;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;28;-2094.946,58.43747;Inherit;False;Property;_noise01uv_speed;noise01uv_speed;1;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;29;-2093.946,293.4375;Inherit;False;Property;_noise02uv_speed;noise02uv_speed;3;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1535.811,1046.941;Half;False;Property;_NOISE03INT;NOISE03INT;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;20;-1598.102,446.1031;Half;False;Property;_NOISE1_2COL;NOISE1_2COL;4;1;[HDR];Create;True;0;0;0;False;0;False;1,0.9119223,0.2971698,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;24;-1589.214,879.9991;Half;False;Property;_NOISE3COL;NOISE3COL;8;1;[HDR];Create;True;0;0;0;False;0;False;0.8018868,0.3386145,0.2534265,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-1545.102,611.1031;Half;False;Property;_NOISE1_2INT;NOISE1_2INT;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;22;-1670.989,687.1653;Inherit;True;Property;_NOISE03;NOISE03;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-1676.102,258.1031;Inherit;True;Property;_NOISE02;NOISE02;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-1120.014,463.3283;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;33;-1607.163,1364.499;Inherit;True;Property;_zhezhao;zhezhao;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;44;-1202.3,1006.302;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;-1276.108,1623.556;Half;False;Property;_zhezhao_int;zhezhao_int;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-884.3,687.3019;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;6;-814.7775,864.4053;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-672.5469,865.9099;Half;False;True;-1;2;ASEMaterialInspector;100;1;Unlit/liudong_zhezhaoUV;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;8;5;False;-1;1;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;True;0;False;-1;True;2;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;2;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=1E38158F880757469FDE4F502E4CE4B2C4E550EA
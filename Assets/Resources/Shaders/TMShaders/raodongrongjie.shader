	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = ( ( ( ( tex2DNode2.r * _zhezhao_int ) + ( ( tex2D( _noise02, panner50 ).r * tex2DNode2.r * tex2D( _noise01, panner37 ).r ) * _noise_shuchu_col.r * _noise_shuchu_int ) ) + ( ( ifLocalVar10 - ifLocalVar12 ) * _bian_col ) + ( fresnelNode24 * _fre_col ) ) * ifLocalVar10 * tex2DNode2.r );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18800
7;138;1920;857;2918.159;744.3245;1.770957;True;False
...
Node;AmplifyShaderEditor.Vector2Node;52;-2856.368,-692.8646;Half;False;Property;_noise02UV_speed;noise02UV_speed;7;0;Create;True;0;0;0;False;0;False;-0.1,0.1;-0.01,0.015;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;18;-1915.049,119.4984;Half;False;Property;_rongjie;rongjie;14;0;Create;True;0;0;0;False;0;False;0.3319695;0.33;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1845.149,379.6985;Half;False;Property;_liangbian_kuan;liangbian_kuan;13;0;Create;True;0;0;0;False;0;False;0.023;0.023;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;38;-2782.502,-231.2712;Half;False;Property;_noise01UV_speed;noise01UV_speed;4;0;Create;True;0;0;0;False;0;False;0.25,-0.1;0.02,-0.02;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;33;-1840.861,497.1337;Inherit;False;Property;_lizi_Kzhen_kaiguan;lizi_Kzhen_kaiguan;16;1;[Enum];Create;True;2;;;2;vertex col;1;rongjie;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;51;-2478.368,-833.8646;Inherit;True;Property;_noise02;noise02;5;0;Create;True;0;0;0;False;0;False;-1;9a5e528b267ca6e4f8142b0e51a681b9;77c1afb3681b88e43ab12f7f792ef025;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-2442.987,-608.1863;Inherit;True;Property;_zhezhao;zhezhao;8;0;Create;True;0;0;0;False;0;False;-1;7071e07fa23648d419aea21e368c17ec;7071e07fa23648d419aea21e368c17ec;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1748.774,-567.7757;Inherit;False;Property;_zhezhao_int;zhezhao_int;9;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-2069.888,-176.6645;Half;False;Property;_noise_shuchu_int;noise_shuchu_int;11;0;Create;True;0;0;0;False;0;False;1.5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;42;-2098.616,-366.7213;Half;False;Property;_noise_shuchu_col;noise_shuchu_col;10;0;Create;True;0;0;0;False;0;False;0.4056604,0.4056604,0.4056604,1;0.2428355,0.2564782,0.4811321,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;-1596.132,-694.0709;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;-718.064,602.1138;Half;False;Property;_bian_col;bian_col;15;1;[HDR];Create;True;0;0;0;False;0;False;1,0.9229986,0.4292453,1;0.3773585,0.3773585,0.3773585,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;62;-1336.082,-441.474;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;22;-362.7318,-347.6521;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=BC28E7489E5FDB0F8F106FD02FD7D0DD04F537BF